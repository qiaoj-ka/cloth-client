    ...
    <div class="fillcontain">
        ...
        <div class="table_container">
            <el-table :data="tableData" style="width: 100%" max-height="450" border >
                ...
                <el-table-column prop="clothType" label="服装类型" align="center" width="500">
                </el-table-column>
        ...
        <clothViewDialog :dialog3="dialog3" @update="getProfile" :formData="Data"></clothViewDialog>
    </div>
...
import clothViewDialog from '../components/ClothViewDialog'
export default {
    name:"personalclothList",
    components: {
        clothViewDialog
    },
    data () {
