            ...
            <div class="form">
                <el-form ref="form" :model="formData" :rules="form_rules" label-width="120px" style="margin:10px;width:auto;">
                    <el-form-item label="服装类型：" prop="clothType">
                        <el-input v-model="formData.clothType" type="clothType"></el-input>
                    </el-form-item>
...
export default {
    ...
    data () {
        return {       
            ...
            form_rules:{
                clothType:[
                    { required: true, message: '请输入服装类型', trigger: 'blur' }
                ],
                price:[
                ...
                if (valid) {
                    ...
                    if(isNaN(this.formData.userlist_Name)){
                        if(this.formData.userlist_Name == "无"){
                            pojo = {
                            clothId:this.formData.id,
                            clothType:this.formData.clothType,
                    ...
                    clothApi.updatecloth(pojo).then(res =>{
                        //修改成功之后的处理
                        if(res.data.flag){
                            this.$message({
                            message: "修改成功",
